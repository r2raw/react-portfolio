...
import { dallasImages } from "../../myData";
import { motion } from "framer-motion";
import Modal from "../../UI/Modal";
function DallasImages() {
        ...
        <>
            {selectedImage && (
                <Modal onClose={handleClose}>
                    <div className="lg:w-[675px] grid gap-4 justify-center items-center mx-auto">
                        <img
                            className="w-full h-[600px] object-fit"
                            src={dallasImages[selectedImage - 1].imgSrc}
                        />
                        <div className=" flex gap-2">
                            {dallasImages.map((img) => {
                                return (
                                    <img
